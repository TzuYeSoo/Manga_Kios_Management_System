...
namespace Admin_Manga_Management {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class AdminDataTable : global::System.Data.TypedTableBase<AdminRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AdminRow AddAdminRow(string Admin_ID, string Admin_UserName, string Admin_Password, string Contact) {
...
namespace Admin_Manga_Management.Database1DataSet3TableAdapters {
    ...
    public partial class AdminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Admin] WHERE (([Admin_ID] = @Original_Admin_ID) AND ([Admin_Us" +
                ...
                "word) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original" +
                "_Contact)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Admin] ([Admin_ID], [Admin_UserName], [Admin_Password], [Conta" +
                "ct]) VALUES (@Admin_ID, @Admin_UserName, @Admin_Password, @Contact);\r\nSELECT Adm" +
                "in_ID, Admin_UserName, Admin_Password, Contact FROM Admin WHERE (Admin_ID = @Adm" +
                "in_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Admin] SET [Admin_ID] = @Admin_ID, [Admin_UserName] = @Admin_UserName, [Admin_Password] = @Admin_Password, [Contact] = @Contact WHERE (([Admin_ID] = @Original_Admin_ID) AND ([Admin_UserName] = @Original_Admin_UserName) AND ([Admin_Password] = @Original_Admin_Password) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)));
SELECT Admin_ID, Admin_UserName, Admin_Password, Contact FROM Admin WHERE (Admin_ID = @Admin_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Admin_ID, Admin_UserName, Admin_Password, Contact FROM dbo.Admin";
        ...
        public virtual int Fill(Database1DataSet3.AdminDataTable dataTable) {
        ...
        public virtual Database1DataSet3.AdminDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.AdminDataTable dataTable = new Database1DataSet3.AdminDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.AdminDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Admin_ID, string Original_Admin_UserName, string Original_Admin_Password, string Original_Contact) {
        ...
        public virtual int Insert(string Admin_ID, string Admin_UserName, string Admin_Password, string Contact) {
            if ((Admin_ID == null)) {
        ...
        public virtual int Update(string Admin_ID, string Admin_UserName, string Admin_Password, string Contact, string Original_Admin_ID, string Original_Admin_UserName, string Original_Admin_Password, string Original_Contact) {
            if ((Admin_ID == null)) {
                throw new global::System.ArgumentNullException("Admin_ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Admin_UserName, string Admin_Password, string Contact, string Original_Admin_ID, string Original_Admin_UserName, string Original_Admin_Password, string Original_Contact) {
            return this.Update(Original_Admin_ID, Admin_UserName, Admin_Password, Contact, Original_Admin_ID, Original_Admin_UserName, Original_Admin_Password, Original_Contact);
        }
    }
